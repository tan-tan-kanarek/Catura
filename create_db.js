...
fs.exists('./db', (exists) => {
    ...
    db.serialize(function() {
    	...
    	db.run("CREATE TABLE messages (id INTEGER PRIMARY KEY AUTOINCREMENT, type INTEGER, title TEXT, description TEXT, image TEXT, entryId TEXT, createdAt INTEGER, lat REAL, lng REAL, radius INTEGER)");
