...
fs.exists('./db', (exists) => {
    ...
    db.serialize(function() {
    	db.run("CREATE TABLE markers (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, description TEXT, entryId TEXT, createdAt INTEGER, lat REAL, lng REAL, userId TEXT, userTitle TEXT)");
    	db.run("CREATE TABLE reports (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, description TEXT, entryId TEXT, createdAt INTEGER, lat REAL, lng REAL, userId TEXT, userTitle TEXT)");
